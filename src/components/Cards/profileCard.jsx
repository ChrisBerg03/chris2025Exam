...
function ProfileCard({ id }) {
        ...
        <div className="space-y-4 mb-6">
            ...
            <div className="space-y-2">
                ...
                <input
                    ...
                    onChange={(e) =>
                        handleNestedChange("avatar", "url", e.target.value)
                    }
                ...
                />
                <label className="text-sm text-gray-600">Avatar Alt Text</label>
                <input
                    type="text"
                    value={editData.avatar.alt}
                    onChange={(e) =>
                        handleNestedChange("avatar", "alt", e.target.value)
                    }
                    className="w-full border border-gray-200 p-2 text-sm focus:outline-none focus:border-gray-400"
            ...
            <div className="space-y-2">
                ...
                <input
                    ...
                    onChange={(e) =>
                        handleNestedChange("banner", "url", e.target.value)
                    }
                    className="w-full border border-gray-200 p-2 text-sm focus:outline-none focus:border-gray-400"
                    placeholder="https://url.com/banner.jpg"
                />
                <label className="text-sm text-gray-600">Banner Alt Text</label>
                <input
                    type="text"
                    value={editData.banner.alt}
                    onChange={(e) =>
                        handleNestedChange("banner", "alt", e.target.value)
                    }
                    className="w-full border border-gray-200 p-2 text-sm focus:outline-none focus:border-gray-400"
            ...
            <div className="flex items-center gap-2">
                <input
                    ...
                    onChange={(e) =>
                        handleEditChange("venueManager", e.target.checked)
                    }
                    className="h-4 w-4"
                />
                <label className="text-sm text-gray-600">Venue Manager</label>
            </div>
    ...
    const renderEditVenueForm = (venueId) => (
        <div className="flex flex-col gap-2">
            ...
            <input
                ...
                onChange={(e) =>
                    setEditVenueData((d) => ({ ...d, name: e.target.value }))
                }
            ...
            <input
                ...
                onChange={(e) =>
                    setEditVenueData((d) => ({ ...d, price: e.target.value }))
                }
                className="border p-1 text-sm"
                placeholder="Price per night"
            />
            <label className="flex items-center gap reunited-2 text-sm text-gray-700">
            ...
            {venueError && (
                <div className="text-red-500 text-xs">{venueError}</div>
            )}
        </div>
    );

    const renderEditBookingForm = (bookingId) => (
        <div
        ...
        >
            <div className="flex gap-2">
                <input
                    type="date"
                    value={editBookingData.dateFrom}
                    onChange={(e) =>
                        setEditBookingData((d) => ({
                            ...d,
            ...
            {bookingError && (
                <div className="text-red-500 text-xs">{bookingError}</div>
            )}
        </div>
    );
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        {editingBookingId === booking.id ? (
                                            renderEditBookingForm(booking.id)
                                        ) : (
                                            <>
